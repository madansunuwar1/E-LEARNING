...
export default function Home() {
  return (
    <>
      <div className="text-black border-b-2 font-Oswald flex flex-col py-24 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="py-16 gap-7 border-b-2 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <div className="flex justify-center">
          <ul className="text-green-200 mt-8 flex flex-col gap-4 list-disc">
            <li>
              What is main concern of students ?
              <p className=" before:'->'">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius est sit sint aliquid, tempore suscipit!</p>
            </li>
            <li>
