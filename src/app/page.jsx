...
export default function Home() {
  return (
    <>
      <div className="text-black border-b-2 font-Oswald flex flex-col pb-8 pt-4 md:py-24 sm:px-8 md:px-12 lg:px-20 xl:px-48 relative">
          ...
          <div className="text-6xl md:text-9xl text-white font-bold">
            <div className="relative font-Lora">
              ...
              <div className="absolute mt-64 ml-12 text-center">
                ...
                <div className="text-green-600">REPEAT</div>
              </div>
            </div>
          </div>
        </div>
        <Link href='/exam' className="mx-auto"><button className="text-green-600 mt-56 border px-5 py-2 text-xl font-semibold hover:bg-white hover:text-black md:hidden">Take test</button></Link>
        <div className="absolute text-green-500 w-full md:w-[80%] top-[70%] md:top-[90%] flex justify-between font-Oswald text-2xl font-thin">
        <p className="hidden md:flex">Created by us</p>
        <Link href='/exam'><button className="text-green-600 border px-5 py-2 text-xl font-semibold hover:bg-white hover:text-black hidden md:flex">Take test</button></Link>
      </div>
      </div>
      
      <div className="py-20 flex gap-7 border-b-2 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        <h1 className="text-green-600 text-2xl font-[500] text-center font-Oswald">Greetings, Students!</h1>
        <p className="text-green-600 font-extralight font-Oswald text-md text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque labore porro voluptas. Nostrum, quos numquam tempore non saepe voluptatem voluptatum voluptates explicabo eum fugiat, nihil obcaecati. Voluptate perspiciatis, magnam magni voluptatem animi, deserunt, saepe illum facere sint veniam fuga iure architecto dolore dolorum accusantium esse repudiandae eius iusto? Cumque quis officiis dolorum excepturi ad fugit harum explicabo laudantium reprehenderit temporibus vitae eligendi repellendus dolore quia, quaerat nam magnam incidunt ab molestias accusantium obcaecati eveniet? Obcaecati voluptatibus aliquid animi molestias fuga nobis excepturi.</p>
      </div>
      <div className="py-16 gap-7 border-b-2 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        <h1 className="text-green-600 text-4xl font-[500] text-center font-Oswald">FAQ</h1>
        <div className="flex justify-center">
          <ul className="text-green-600 mt-8 font-extralight flex flex-col gap-4 list-disc font-Oswald text-md text-justify mx-6">
            <li>
